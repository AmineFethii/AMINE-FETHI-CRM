    ...
    <div className="space-y-8 animate-fade-in pb-20">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
          <div className="p-6 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between min-h-[84px]">
            <h3 className="font-bold text-slate-900 flex items-center gap-2">
              <Hash size={18} className="text-blue-500" /> {t.details}
            </h3>
            <button 
              onClick={handleDownloadPDF}
              className="flex items-center gap-2 bg-blue-600 text-white px-5 py-2 rounded-xl font-bold shadow-lg shadow-blue-900/20 hover:bg-blue-700 transition-all active:scale-95 text-sm"
              ...
              {invoiceData.recipientType === 'portfolio' ? (
                <div className="relative group">
                  ...
                  <select 
                    ...
                    className="w-full pl-12 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none"
                  >
        ...
        <div className="flex flex-col items-center">
          {/* THE TEMPLATE BOX */}
          <div className="w-full max-w-[800px] bg-white shadow-[0_20px_50px_rgba(0,0,0,0.1)] aspect-[1.414/2] p-[5%] flex flex-col font-sans text-slate-900 border border-slate-100 print:shadow-none print:p-0" id="invoice-printable">
             ...
             <div className="flex justify-between items-end mb-10 border-b border-slate-100 pb-8">
                ...
                <div className="text-right space-y-1">
                   <p className="text-[12px] font-black text-slate-800 uppercase">Facture N° : <span className="text-[#1e3a8a]"># {invoiceData.number}</span></p>
                   <p className="text-[12px] font-bold text-slate-800">{t.doneAt} {new Date(invoiceData.date).toLocaleDateString('fr-FR')}</p>
                </div>
             </div>
